...
For Debian-based distros click Releases and then **`mate-classic-icons_260308.deb`**.  If you have the `gdebi` package already installed double-clicking the downloaded .deb will install it.  Otherwise open a terminal and run:—

```
sudo apt install path-to/mate-classic-icons_260308_all.deb
```
so if it's in your Downloads directory you'd actually type:—
  
```
sudo apt install ~/Downloads/mate-classic-icons_260308_all.deb
```
